...
export class MiembroFormCrearComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<MiembroFormCrearComponent>,
  ...
  public async onSubmit() {
    if (this.miembroForm.valid) {
      ...
      if (this.editMode && this.data.id) {
        ...
        if (this.selectedPersona) {
          await this.personaService.updatePersona(this.selectedPersona).toPromise();
        }
      } else {
